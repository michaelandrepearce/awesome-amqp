...
> The Advanced Message Queuing Protocol (AMQP) is the internet
> protocol for business messaging. It is designed to be secure,
> reliable, interoperable, standard, and open.
...
* [Brokers](#brokers)
* [Routers, Adapters, and Bridges](#routers-adapters-and-bridges)
...
* [AMQP 1.0 Specification](http://docs.oasis-open.org/amqp/core/v1.0/os/amqp-core-overview-v1.0-os.html) - The core protocol specification.
* [OASIS Technical Committee](https://www.oasis-open.org/committees/tc_home.php?wg_abbrev=amqp) - Information about the AMQP Technical Committee.
* [ISO/IEC Standard](http://www.iso.org/iso/home/store/catalogue_tc/catalogue_detail.htm?csnumber=64955) - XXX
* [AMQP Addressing Specification](https://www.oasis-open.org/committees/download.php/52063/amqp-addressing-v1.0-wd05.pdf) - Defines a standard text based syntax and semantics for message addresses used with AMQP (working draft).
* [AMQP Management Specification](https://www.oasis-open.org/committees/download.php/54441/AMQP%20Management%20v1.0%20WD09) - Defines a request/response protocol over AMQP to perform management operations (working draft).
* [AMQP JMS Mapping Specification](https://www.oasis-open.org/committees/download.php/53086/amqp-bindmap-jms-v1.0-wd05.pdf) - Defines a mapping between JMS messages and AMQP message (working draft).
* [AMQP WebSocket Binding Specification](http://docs.oasis-open.org/amqp-bindmap/amqp-wsb/v1.0/amqp-wsb-v1.0.html) - Defines using the WebSocket protocol as a transport for AMQP (Committee Specification 01).
* [AMQP Claims-based Security Specification](https://www.oasis-open.org/committees/download.php/50506/amqp-cbs-v1%200-wd02%202013-08-12.doc) - Defines a layered protocol to authenticate AMQP clients using security tokens (working draft).

## Introduction

* [amqp.org](http://www.amqp.org/) - The AMQP website.
...
* [Apache Qpid Broker for Java](http://qpid.apache.org/components/java-broker/) - A pure-Java AMQP message broker.
...
* [Apache Qpid Proton](https://qpid.apache.org/proton/index.html) - The AMQP messaging toolkit in various languages.
  * Proton-C - C and its language bindings (C++, Go, JavaScript, Perl, PHP, Python, and Ruby).
  * Proton-J - Java.
...
* [AMQP protocol built in type system by example](https://paolopatierno.wordpress.com/2015/07/20/amqp-protocol-the-builtin-type-system-by-examples/) by Paolo Patierno. Introduction to AMQP frames and the built-in type system.
